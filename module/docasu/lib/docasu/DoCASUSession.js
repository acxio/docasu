...
Ext.namespace("DoCASU.App.Session");
 ...
 */
DoCASU.App.Session.getSessionExpiredKeyTags = function() {
 ...
 */
DoCASU.App.Session.isSessionExpired = function(response) {
 	/** 
 	...
 	try {
		...
		var tags = DoCASU.App.Session.getSessionExpiredKeyTags();
		for(i in tags) {
