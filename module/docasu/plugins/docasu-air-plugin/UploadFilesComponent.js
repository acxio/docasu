...
/* constructor */
DoCASU.App.Air.UploadFilesComponent = function(config) {
	Ext.apply(this, config);
	
	// call parent
	DoCASU.App.Air.UploadFilesComponent.superclass.constructor.apply(this, arguments);
...
Ext.extend(DoCASU.App.Air.UploadFilesComponent, DoCASU.App.Component, {
	...
	init : function() {
		// call parent
		DoCASU.App.Air.UploadFilesComponent.superclass.init.apply(this, arguments);
		var uiWidget;
		try {
		...
		uploadPanel.on("beforeallstart", function (obj) {
			var component = DoCASU.App.PluginManager.getPluginManager().getComponent("UploadFilesComponent", "DoCASU.App.Air");
...
}); // eo DoCASU.App.Air.UploadFilesComponent
